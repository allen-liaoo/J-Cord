...
/**
 * IModifier - A modifier that support chainable methods to update multiple {@link Attribute} of an instance at once.
 *
...
public interface IModifier<R> extends IDiscordObject {
     ...
     * This will constructs an json object with every {@link Attribute} that requires update,
