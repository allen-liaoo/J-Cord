...
## More
- [Javadocs](https://jitpack.io/com/github/AlienIdeology/J-Cord/-SNAPSHOT/javadoc/) Generated by JitPack
- Todo List: [Todo.md](/docs/Todo.md)
- Project structure:
  - [Object Hierarchy.md](/docs/Object_Hierarchy.md)
  - [Event Hierarchy.md](/docs/Event_Hierarchy.md)
- Don't forget to check out the [Wiki](https://github.com/AlienIdeology/J-Cord/wiki)